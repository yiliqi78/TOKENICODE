...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'provider.formatHint': 'Claude Code CLI 仅支持 Anthropic 原生格式。选择 OpenAI 格式需要提供商支持自动转换。',
  ...
  en: {
    ...
    'provider.formatOpenai': 'OpenAI Chat Completions',
    'provider.formatHint': 'Claude Code CLI only supports Anthropic native format. OpenAI format requires provider-side auto-conversion.',
