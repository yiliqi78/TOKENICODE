...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'cmd.usageOutput': '输出',
    'cmd.usageTotal': '合计',
    'cmd.usageCacheHit': '缓存命中率',
    'cmd.usageCacheRead': '缓存读取',
    'cmd.usageCacheCreated': '缓存写入',
  ...
  en: {
    ...
    'cmd.usageCacheHit': 'Cache Hit Rate',
    'cmd.usageCacheRead': 'Cache Read',
    'cmd.usageCacheCreated': 'Cache Written',
