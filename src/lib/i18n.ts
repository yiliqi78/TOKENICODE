...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'files.copyFile': '拷贝',
    'files.copyAll': '全文复制',
    'files.copiedAll': '已复制全文',
    'files.copyFailed': '复制失败',
    'files.highlight': '高亮',
    'files.highlight.red': '红色',
    'files.highlight.yellow': '黄色',
    'files.highlight.green': '绿色',
    'files.highlight.purple': '紫色',
    'files.removeHighlight': '取消高亮',
    'files.clearHighlights': '清除所有标记',
    'files.highlightsCleared': '已清除所有 Highlight 标记',
    'files.clearHighlightsFailed': '清除 Highlight 失败',
    'files.noHighlights': '没有 Highlight 标记',
    'files.paste': '粘贴',
    'files.rename': '重命名',
    'files.delete': '删除',
    ...
    'settings.previewLayout': '文件预览布局',
    'settings.previewLayoutKeepList': '保留文件列表',
    'settings.previewLayoutFocus': '收起文件列表',
    'settings.light': '浅色',
    'settings.dark': '深色',
    'settings.gray': '灰色',
  ...
  en: {
    ...
    'files.copyFile': 'Copy',
    'files.copyAll': 'Copy Full Text',
    'files.copiedAll': 'Copied full text',
    'files.copyFailed': 'Copy failed',
    'files.highlight': 'Highlight',
    'files.highlight.red': 'Red',
    'files.highlight.yellow': 'Yellow',
    'files.highlight.green': 'Green',
    'files.highlight.purple': 'Purple',
    'files.removeHighlight': 'Remove highlight',
    'files.clearHighlights': 'Clear all marks',
    'files.highlightsCleared': 'Cleared all Highlight marks',
    'files.clearHighlightsFailed': 'Failed to clear Highlight marks',
    'files.noHighlights': 'No Highlight marks found',
    'files.paste': 'Paste',
    'files.rename': 'Rename',
    'files.delete': 'Delete',
    ...
    'settings.previewLayout': 'File Preview Layout',
    'settings.previewLayoutKeepList': 'Keep File List',
    'settings.previewLayoutFocus': 'Hide File List',
