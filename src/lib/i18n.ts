...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'feedback.title': '提交反馈',
    'feedback.subtitle': '遇到问题或想提建议？直接告诉我们，描述会随环境信息一起发送给开发团队',
    'feedback.descriptionPlaceholder': '描述一下你遇到的问题或建议，越具体越好（可粘贴截图）',
    'feedback.pasteHint': '支持 Ctrl/Cmd+V 粘贴截图',
    'feedback.addScreenshot': '添加截图',
    'feedback.removeScreenshot': '移除截图',
    'feedback.contactPlaceholder': '联系方式（可选）— 邮箱 / 微信 / 飞书手机号',
    ...
    'feedback.notConfigured': '反馈功能未在此构建中配置。请联系开发者或等待下一个版本。',
